...
var contractAddress = '0xBc0D03647C564C9CaFFb3c217f26cB34c57b8D81';
// var auction = auctionContract.at(contractAddress); 
auctionContract.options.address = '0xBc0D03647C564C9CaFFb3c217f26cB34c57b8D81';

function bid() {
var mybid = document.getElementById('value').value;

auctionContract.methods.bid().send({from: '0xe09b09ea2B250aef59Ca52D1D643f8E7BBBE72B7', value: web3.utils.toWei(mybid, "ether"), gas: 200000}).then((result)=>{
  console.log(result)
  // 
